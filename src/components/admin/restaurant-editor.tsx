      ...
      {tab === "finance" ? (
        <div className="editor-content-grid">
          <section className="admin-form-card wide-form-card">
            ...
            <div className="finance-grid"><article><small>Доставка водителем Direct</small><strong>15%</strong><span>после ресторанных скидок</span></article><article><small>Доставка курьером ресторана</small><strong>7%</strong><span>после скидок</span></article><article><small>Самовывоз</small><strong>15%</strong><span>после скидок</span></article></div>
            <div className="field-grid two-columns"><label className="field-label">Режим расчёта<select defaultValue="UNRESOLVED" onChange={() => onDecisionRequired("Режим расчёта", "Для пилота ещё не выбран основной режим расчёта: за каждый заказ или ежедневно.")}><option value="UNRESOLVED">Не выбран для пилота</option><option value="PER_ORDER">За каждый заказ</option><option value="DAILY">Ежедневно</option><option value="MANUAL">Вручную</option></select></label><label className="field-label">Лимит задолженности<input value="Не утверждён" readOnly /></label></div>
