...
import { restaurantNavItems } from "./restaurant-nav";
 ...
 * COMBINED — «Кухня» и «Меню и доступность»; SPLIT — «Оператор заказов» первым.
 * Сам режим переключается шестерёнкой справа, а не рабочим разделом.
 */
export function RestaurantHeader() {
  ...
  return (
    <WorkspaceHeader
      ...
      navItems={restaurantNavItems(mode)}
