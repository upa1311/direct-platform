...
export default function ClientCartPage() {
  ...
  return (
    <form id="checkout-cart" onSubmit={handleSubmit}>
      ...
      {/* §1/§2: статус доступности показывает ТОЛЬКО компактный бейдж в
          заголовке оформления — дублирующая строка «Оформление временно
          недоступно.» удалена; кнопка отправки при этом остаётся заблокированной
          через canSubmitOrder. */}
      {hasUnavailableItem ? (
