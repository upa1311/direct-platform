 ...
 * если snapshot отсутствует, устарел (сменился restaurantId/timeZone), result не
 * ok или view = null. Не перестраивает выписку и не берёт новый Date.now —
 * использует зафиксированный asOfIso из envelope. Ничего не мутирует.
 */
