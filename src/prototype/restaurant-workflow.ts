...
const KITCHEN_ACTIONS: ReadonlySet<RestaurantWorkspaceAction> = new Set([
  "ADJUST_ETA",
  // Каталог блюд ведёт кухня: она заводит новое блюдо и отправляет его на
  // модерацию Direct. Это НЕ то же самое, что CHANGE_MENU_AVAILABILITY —
  // временное включение/выключение уже существующих позиций.
  "MANAGE_MENU_CATALOG",
