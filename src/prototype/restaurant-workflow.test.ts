...
test("COMBINED разрешает все ресторанные действия", () => {
  for (const a of ["ACCEPT_ORDER", "SET_INITIAL_ETA", "ADJUST_ETA", "MARK_READY", "REPORT_PREPARATION_PROBLEM", "MANAGE_CUSTOMER", "MANAGE_CANCELLATION", "MANAGE_DRIVER", "HANDOFF_ORDER", "PAUSE_RESTAURANT", "CHANGE_MENU_AVAILABILITY"] as const) {
